...
export default function UppyDashboard({userId, item, setItem}) {
  ...
  return <Dashboard uppy={dashboardUppy} proudlyDisplayPoweredByUppy={false} height={250} locale={{strings: { done: "Replace image" }}} hideProgressAfterFinish={true} showLinkToFileUploadResult={false}/>
}
