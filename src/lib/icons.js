const icons = {
  ...
  search: {
    path: (color) => (
      <path
        fill={color}
        d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0 93.1 0 0 93.1 0 208c0 114.9 93.1 208 208 208 48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34ZM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128Z"
      />
    ),
    viewBox: "0 0 512 512",
  },
  ...
  tutorial: {
    path: (color) => (
      <path
        fill={color}
        d="M496 128v16 0c0 4.41-3.59 8-8 8h-24v12c0 6.62-5.38 12-12 12H60c-6.63 0-12-5.38-12-12v-12H24v0c-4.42 0-8-3.59-8-8v-16 0c0-3.24 1.95-6.16 4.94-7.4l232-88v0c1.95-.82 4.15-.82 6.11 0l232 88v0c2.99 1.23 4.94 4.15 4.94 7.39Zm-24 304H40c-13.26 0-24 10.74-24 24v16 0c0 4.41 3.58 8 8 8h464v0c4.41 0 8-3.59 8-8v-16c0-13.26-10.75-24-24-24ZM96 192v192H60c-6.63 0-12 5.37-12 12v20h416v-20c0-6.63-5.38-12-12-12h-36V192h-64v192h-64V192h-64v192h-64V192H96Z"
      />
    ),
    viewBox: "0 0 512 512",
  },
  ...
  expand: {
    path: (color) => (
      <path
        fill={color}
        d="M448 344v112 0c.03 13.22-10.66 23.96-23.88 24 -.05 0-.09 0-.13 0h-112c-21.39 0-32.09-25.9-17-41l36.2-36.2 -107.2-107.2 -107.23 107.3 36.23 36.1c15.09 15.1 4.39 41-17 41h-112 0c-13.23.03-23.97-10.66-24-23.88 -.01-.05-.01-.09 0-.13v-112c0-21.4 25.89-32.1 41-17l36.19 36.2 107.27-107.2 -107.28-107.3 -36.18 36.3c-15.1 15.1-41 4.4-41-17v-112 0c-.04-13.23 10.65-23.97 23.87-24 .04-.01.08-.01.12 0h112c21.39 0 32.09 25.9 17 41l-36.2 36.2 107.2 107.2 107.23-107.3 -36.23-36.1c-15.09-15.1-4.39-41 17-41h112v0c13.22-.04 23.96 10.65 24 23.87 0 .04 0 .08 0 .12v112c0 21.4-25.89 32.1-41 17l-36.19-36.2 -107.27 107.2 107.28 107.3 36.18-36.2c15.1-15.2 41-4.5 41 16.9Z"
      />
    ),
    viewBox: "0 0 448 512",
  },
  ...
  chevronDown: {
    path: (color) => (
      <path
        fill={color}
        d="M207.029 381.47L12.68 187.12c-9.38-9.38-9.38-24.57-.001-33.941L35.35 130.51c9.357-9.357 24.522-9.375 33.9-.04L223.99 284.49 378.74 130.46c9.37-9.34 24.54-9.32 33.9.04l22.66 22.667c9.37 9.37 9.37 24.56 0 33.941l-194.35 194.34c-9.38 9.37-24.57 9.37-33.95 0Z"
      />
    ),
    viewBox: "0 0 448 512",
  },
  chevronLeft: {
    path: (color) => (
      <path
        fill={color}
        d="M34.52 239.03L228.87 44.69c9.37-9.37 24.57-9.37 33.94 0l22.67 22.67c9.36 9.36 9.37 24.52.04 33.9L131.49 256l154.02 154.75c9.34 9.38 9.32 24.54-.04 33.9l-22.67 22.67c-9.37 9.37-24.57 9.37-33.94 0L34.52 272.97c-9.37-9.37-9.37-24.57-.001-33.94Z"
      />
    ),
    viewBox: "0 0 320 512",
  },
  chevronRight: {
    path: (color) => (
      <path
        fill={color}
        d="M285.47 272.97L91.12 467.31c-9.38 9.37-24.57 9.37-33.95 0L34.5 444.64c-9.357-9.36-9.375-24.53-.04-33.91l154.02-154.75L34.45 101.23c-9.34-9.38-9.32-24.55.04-33.91L57.16 44.65c9.37-9.38 24.56-9.38 33.94 0l194.34 194.34c9.37 9.37 9.37 24.56 0 33.94Z"
      />
    ),
    viewBox: "0 0 320 512",
  },
  chevronUp: {
    path: (color) => (
      <path
        fill={color}
        d="M240.971 130.524l194.34 194.34c9.37 9.37 9.37 24.56 0 33.94l-22.67 22.66c-9.36 9.35-24.53 9.375-33.91.04l-154.75-154.02L69.23 381.5c-9.38 9.33-24.55 9.31-33.91-.04L12.65 358.79c-9.38-9.38-9.38-24.57 0-33.95L206.999 130.5c9.37-9.38 24.56-9.38 33.94-.01Z"
      />
    ),
    viewBox: "0 0 448 512",
  },
  ...
  account: {
    path: (color) => (
      <g id="Group_18" data-name="Group 18" transform="translate(1690 -128)">
        <ellipse
          fill={color}
          id="Ellipse_2"
          data-name="Ellipse 2"
        ...
        <ellipse
          ...
          rx="7.5"
          ry="4"
          transform="translate(-1688 138)"
        />
        <g id="account-circle-round-24px" transform="translate(-1692 126)">
          <path
            id="Path_9"
            data-name="Path 9"
  ...
  clock: {
    viewBox: "0 0 512 512",
    path: (color) => (
      <path d="M256 8C119 8 8 119 8 256c0 137 111 248 248 248s248-111 248-248C504 119 393 8 256 8Zm0 448c-110.5 0-200-89.5-200-200s89.5-200 200-200 200 89.5 200 200 -89.5 200-200 200Zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6Z" />
    ),
  },
  twitter: {
    viewBox: "0 0 512 512",
